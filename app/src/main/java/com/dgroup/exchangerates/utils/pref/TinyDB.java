...
public class TinyDB {
    ...
    public TinyDB(Context appContext) {
        preferences = appContext.getSharedPreferences(TinyDbKeys.NAME_SHARED_PREFERENCES, Context.MODE_PRIVATE);
    }
     ...
     * Get String value from SharedPreferences at 'key'. If key not found, return ""
     * @param key SharedPreferences key
     * @param pDefaultValue String value returned if exception is thrown
     * @return String value at 'key' or pDefaultValue if key not found
     */
    public String getString(String key, String pDefaultValue) {
        return preferences.getString(key, pDefaultValue);
    }
     ...
     */
    public void putUserId(String key, int value) {
